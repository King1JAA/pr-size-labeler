 ...
 * Shows badge progress for PR Size Labeler and a Day 1 -> Month 1 roadmap.
 * Usage:
...
function printBadgeTable() {
  console.log('=== PR Size Labeler — Achievement Badge Progress ===\n');
...
function printRoadmap() {
  console.log('=== PR Size Labeler — Day 1 -> Month 1 Roadmap ===\n');
  const roadmap = [
